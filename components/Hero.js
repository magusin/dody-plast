  ...
  return (
    <section className="relative h-[470px] flex items-center justify-center text-center text-white">
      ...
      <div className="relative z-10 px-6">
        {title && <h1 className="text-4xl md:text-6xl font-extrabold mb-6 drop-shadow">{title}</h1>}
        {subtitle && <p className="max-w-2xl mx-auto text-lg md:text-xl mb-6">{subtitle}</p>}
        {ctaLabel && (
          <Link
          href="/contact"
          className="ml-2 inline-flex items-center justify-center rounded-lg px-6 py-4
